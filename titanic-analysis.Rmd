...
### 3.1 Bubble Chart: Edad, Tarifa, Clase y Supervivencia
...
## 3.3 Imagen compuesta: Edad vs Tarifa por Puerto y Género
...
fig_heat <- plot_ly(
  ...
  layout(
    title  = 'Heatmap: Tasa de Supervivencia (%) por Clase y Puerto',
...
## 1. **Clase Social: El Determinante Principal**

-   **Primera clase**:
    -   Supervivencia del **46%**, claramente mayor a segunda y tercera clase (**32%** y **33%**).\
    -   Pasajeros con tarifas \>100 USD tuvieron tasas cercanas al **70%** (Gráfico burbujas).\
    -   Adultos mayores (60+ años) en primera clase sobrevivieron más que en otras clases (Gráfico de grupos de edad).
-   **Tercera clase**:
    -   Solo el **33%** sobrevivió, con tasas críticas para ancianos (**0%**) y niños (menor que en 1ra y 2da).\
    -   Concentración de víctimas en tarifas \<20 USD (Gráfico *Edad vs Tarifa*).

> **Clave**: La ubicación en cubiertas superiores y el acceso prioritario a botes convirtieron la clase social en el factor más decisivo.

------------------------------------------------------------------------

## 2. **Género: Una Ventaja Relativa**

-   **Mujeres**:
    -   Supervivencia del **74%** vs **19%** en hombres.\
    -   En tercera clase, solo el **12%** de las mujeres sobrevivió, comparado con el **97%** en primera (Facetas).
-   **Hombres**:
    -   Mayor mortalidad en todas las clases, especialmente en tercera (**86%** fallecidos).\
    -   Niños varones en primera clase: **0%** de supervivencia (Gráfico de grupos de edad).

> **Clave**: La política de género favoreció a las mujeres, pero su efectividad dependió críticamente de la clase social.

------------------------------------------------------------------------

## 3. **Edad y Tarifa: Factores Secundarios pero Reveladores**

-   **Niños (\<18 años)**:
    -   Supervivencia del **53%**, pero con disparidades extremas:
        -   **0%** en primera clase vs **60%** en segunda (Gráfico de grupos de edad).
-   **Tarifa**:
    -   Correlación positiva con supervivencia (r = 0.25).\
    -   Pasajeros que pagaron \>50 USD tuvieron una tasa del **68%** vs **22%** en tarifas \<20 USD (Heatmap).

> **Clave**: La tarifa actuó como proxy de ubicación física en el barco, no solo de recursos económicos.

------------------------------------------------------------------------

## 4. **Puerto de Embarque: El Factor Olvidado**

-   **Cherburgo (C)**:
    -   Mayor proporción de pasajeros de primera clase (**47%**) y supervivencia general del **55%**.\
    -   Tasas altas incluso en tercera clase (**22%** vs **13%** en Southampton).
-   **Queenstown (Q)**:
    -   Polarización extrema: **100%** de supervivencia en primera clase vs **0%** en segunda.

> **Clave**: El puerto reflejó composiciones socioeconómicas distintas, donde Cherburgo agrupó a pasajeros adinerados.

------------------------------------------------------------------------

## 5. **Interacciones Multidimensionales**

-   **Combinación crítica**:\
    Hombres de tercera clase, embarcados en Southampton, con tarifas \<20 USD tuvieron una mortalidad del **89%** (Gráfico de burbujas + Heatmap).

-   **Excepciones notables**:

    -   Mujeres en primera clase con tarifas \>200 USD: **100%** de supervivencia.\
    -   Niñas en segunda clase: **80%** salvadas vs **40%** de niños varones.

> **Clave**: La supervivencia fue el resultado de intersecciones complejas entre variables, no de factores aislados.

------------------------------------------------------------------------

## **Lecciones Históricas y Éticas**

1.  **Desigualdad estructural**:\
    La ubicación física en el barco (vinculada a la clase) fue más determinante que normas humanitarias.

2.  **Sesgo de género**:\
    La ventaja femenina se diluyó en ausencia de recursos económicos.

3.  **Vulnerabilidad ignorada**:\
    Ancianos y niños de clases bajas quedaron sistemáticamente excluidos.
